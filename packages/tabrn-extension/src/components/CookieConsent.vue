<template>
  <div class="container" style="width: 500px; height: 200px">
    ...
    <div class="w-100 flex justify-center mx-5 my-4">
      <span id="loading_text" class="text-base font-normal"
        >tabrn collects data that personally identifies you and uses cookies to
        identify your user account when using the extension</span
      >
    </div>
