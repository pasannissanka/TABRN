...
export const Drawer = ({ isDrawerOpen }: DrawerProps) => {
  ...
  return (
    <React.Fragment>
      {!isDrawerOpen && (
        <aside className="z-10 hidden w-64 max-h-screen overflow-hidden overflow-y-auto lg:flex">
          {/* Header */}
          {/* <div className="flex flex-shrink-0 items-center justify-between p-2"></div> */}
          <nav className="fixed flex-1 w-64 overflow-hidden hover:overflow-y-auto">
